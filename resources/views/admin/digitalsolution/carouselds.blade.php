<x-app-layout>
    <div class="container">
        ...
        <button class="btn btn-primary" id="addCarouselBtn" data-bs-toggle="modal" data-bs-target="#carouselModal">Add
            Image</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning editBtn" data-id="{{ $carousel->id }}"
                                data-image="{{ asset('images/' . $carousel->image) }}" data-bs-toggle="modal"
                                data-bs-target="#carouselModal">Edit</button>
    ...
    @push('js')
        ...
        <script>
            ...
            document.getElementById('carouselForm').addEventListener('submit', function(event) {
                ...
                var url = id ? `{{ route('admin.digitalsolution.carouselds.update', '') }}/${id}` :
                    `{{ route('admin.digitalsolution.carouselds.store') }}`;
