...
<div class="container">
    ...
    <table class="table mt-4">
        ...
        <tbody>
            ...
            <tr>
                <td><img src="{{ asset('images/carousel/' . $carousel->image) }}" width="100" height="50" /></td>
                <td>
                    <button class="btn btn-warning editBtn" data-id="{{ $carousel->id }}" data-image="{{ asset('images/carousel/' . $carousel->image) }}" data-bs-toggle="modal" data-bs-target="#carouselModal">Edit</button>
